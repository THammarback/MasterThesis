-- -------------------------------------------------------------
-- 
-- File Name: E:\Downloads\2021b-10mayFINAL\2021b-10mayFINAL\srcFiles\coeff_bank\hdlsrc\coeff_bank_integration_test\rams_block.vhd
...
-- 
-- Module: rams_block
-- Source Path: coeff_bank_integration_test/coeff_bank/dl_filter_bank/multiple_rams/rams
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF rams_block IS
  ...
  FOR ALL : fi_splitter_block4
    USE ENTITY work.fi_splitter_block4(rtl);
...
BEGIN
  USimple_Dual_Port_RAM_System_2 : SimpleDualPortRAM_generic
  ...
  Ufi_splitter_4 : fi_splitter_block4

...
-- File Name: E:\Downloads\2021b-10mayFINAL\2021b-10mayFINAL\srcFiles\coeff_bank\hdlsrc\coeff_bank_integration_test\dl_filter_bank.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dl_filter_bank
-- Source Path: coeff_bank_integration_test/coeff_bank/dl_filter_bank
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF dl_filter_bank IS

  -- Component Declarations
  COMPONENT multiple_rams_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          wr_data                         :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
          wr_addr                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : multiple_rams_block
    USE ENTITY work.multiple_rams_block(rtl);
...
BEGIN
  ...
  Umultiple_rams : multiple_rams_block
    PORT MAP( clk => clk,
              enb => enb,

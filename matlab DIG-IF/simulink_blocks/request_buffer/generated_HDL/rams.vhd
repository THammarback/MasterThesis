-- -------------------------------------------------------------
-- 
-- File Name: E:\Downloads\2021b-10mayFINAL\2021b-10mayFINAL\srcFiles\request_buffer\hdlsrc\request_buffer_test\rams.vhd
...
-- 
-- Module: rams
-- Source Path: request_buffer_test/request_buffer/rams
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_Simple_Dual_Port_RAM7 : SimpleDualPortRAM_singlebit
  ...
  u_Simple_Dual_Port_RAM4 : SimpleDualPortRAM_singlebit
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 1
                 )
    PORT MAP( clk => clk,
  ...
  u_Simple_Dual_Port_RAM3 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_Simple_Dual_Port_RAM1 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 8
                 )
    PORT MAP( clk => clk,
  ...
  u_Simple_Dual_Port_RAM9 : SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,

-- -------------------------------------------------------------
-- 
-- File Name: E:\Downloads\2021b-10mayFINAL\2021b-10mayFINAL\srcFiles\request_buffer\hdlsrc\request_buffer_test\ts_ctrl.vhd
...
-- 
-- Module: ts_ctrl
-- Source Path: request_buffer_test/request_buffer/request_orderer/ts_ctrl
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ts_ctrl IS
  ...
  SIGNAL Delay_out1                       : vector_of_unsigned32(0 TO 63);  -- uint32 [64]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay_out1 <= (OTHERS => to_unsigned(0, 32));
